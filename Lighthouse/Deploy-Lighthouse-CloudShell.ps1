...
Param (
	...
	[String] $LighthouseTemplateFile = "lighthouseTemplate.json",
	[String] $LighthouseTemplateParameterFile = "lighthouseTemplate.parameters.json",
	[Switch] $ValidateOnly 
)
...
Test-AzDeployment -Location $ResourceGroupLocation `
				  -TemplateFile $LighthouseTemplateFile `
				  -TemplateParameterFile $LighthouseTemplateParameterFile `
				  -Verbose
