...
eval "az synapse notebook import --workspace-name $synapse_workspace --name edgraph_dw_v1_0_freq_etl_metadata --spark-pool-name spark3p4sm --file @$this_file_path/notebook/edgraph_dw_v1_0_freq_etl_metadata.ipynb --folder-path 'EdGraph/modules/EdGraph_DW/v1.0/src/main' --only-show-errors"
eval "az synapse notebook import --workspace-name $synapse_workspace --name edgraph_dw_v1_0_main_etl_pipeline --spark-pool-name spark3p4sm --file @$this_file_path/notebook/edgraph_dw_v1_0_main_etl_pipeline.ipynb --folder-path 'EdGraph/modules/EdGraph_DW/v1.0/src/main' --only-show-errors"
eval "az synapse notebook import --workspace-name $synapse_workspace --name edgraph_dw_v1_0_migrate_to_stage3 --spark-pool-name spark3p4sm --file @$this_file_path/notebook/edgraph_dw_v1_0_migrate_to_stage3.ipynb --folder-path 'EdGraph/modules/EdGraph_DW/v1.0/src/main' --only-show-errors"
eval "az synapse notebook import --workspace-name $synapse_workspace --name edgraph_dw_v1_0_populate_sql_db --spark-pool-name spark3p4sm --file @$this_file_path/notebook/edgraph_dw_v1_0_populate_sql_db.ipynb --folder-path 'EdGraph/modules/EdGraph_DW/v1.0/src/main' --only-show-errors"
eval "az synapse notebook import --workspace-name $synapse_workspace --name edgraph_dw_v1_0_s2r_descriptor_views --spark-pool-name spark3p4sm --file @$this_file_path/notebook/edgraph_dw_v1_0_s2r_descriptor_views.ipynb --folder-path 'EdGraph/modules/EdGraph_DW/v1.0/src/main' --only-show-errors"
eval "az synapse notebook import --workspace-name $synapse_workspace --name edgraph_dw_v1_0_semantic_views --spark-pool-name spark3p4sm --file @$this_file_path/notebook/edgraph_dw_v1_0_semantic_views.ipynb --folder-path 'EdGraph/modules/EdGraph_DW/v1.0/src/main' --only-show-errors"
eval "az synapse notebook import --workspace-name $synapse_workspace --name edgraph_dw_v1_0_dw_builder --spark-pool-name spark3p4sm --file @$this_file_path/notebook/edgraph_dw_v1_0_dw_builder.ipynb --folder-path 'EdGraph/modules/EdGraph_DW/v1.0/src/utilities' --only-show-errors"
...
eval "az synapse pipeline create --workspace-name $synapse_workspace --name edgraph_dw_v1_0_main_etl --file @$this_file_path/pipeline/edgraph_dw_v1_0_main_etl.json" 
